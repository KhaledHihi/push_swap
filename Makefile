...
BNS = bonus_files/checker_bonus.c bonus_files/split.c bonus_files/create_node.c bonus_files/add_node_back.c bonus_files/ft_atoi.c bonus_files/print_node.c bonus_files/operations.c  \
		bonus_files/ft_check.c bonus_files/list_size.c bonus_files/oper2.c bonus_files/oper3.c bonus_files/get_next_line/get_next_line.c bonus_files/get_next_line/get_next_line_utils.c bonus_files/parsing.c
